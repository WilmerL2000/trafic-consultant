...
const Hero = ({ heroData, headerData, navData }) => {
  ...
  return (
    <section className="bg-hero bg-no-repeat bg-left-top min-h-[800px] lg:min-h-[950px] lg:mb-80">
      ...
      >
        <motion.div variants={fadeInDown} className="z-20 relative">
        ...
        >
          <Image src={girlImg} width={206} height={495} alt="Girl image" />
        </motion.div>
        <motion.div
          variants={heroTruckAnim}
          className="hidden lg:flex absolute -bottom-[25%] -left-[30%]"
        >
          <Image src={truckImg} width={811} height={395} alt="Girl image" />
        </motion.div>
        <motion.div
          variants={boyAnim}
          className="hidden lg:flex absolute right-[380px] bottom-0 z-10"
        >
          <Image src={boyImg} width={206} height={495} alt="Girl image" />
        </motion.div>
      </motion.div>
    </section>
  );
